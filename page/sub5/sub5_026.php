        ...
        (function init() {
          ...
          insertTargetPosition();
				...
				<div class="sub_container">
					...
					<div class="inner">
						...
						<ul class="tab">
							...
							<li><a href="/page/sub5/sub5_022.php">어반바이올렛</a></li>
							...
							<li class="on"><a href="/page/sub5/sub5_026.php">카라멜라떼</a></li>
							<li><a href="/page/sub5/sub5_027.php">뉴엔틱</a></li>
						</ul>
					</div>
				</div>
				<div class="target-section section"></div>
				<div class="target-section ready section0" id="CaramelLatte">
					<div class="content">
						<h4 class="white">카라멜라떼</h4>
						<span>Concept</span>
						<p class="white">은은한 브라운 벽면과 깔끔한 화이트톤의 바닥으로<br>캬라멜의 '달콤함'과 라떼의 '부드러움'을 표현한 컨셉입니다.</p>
					</div>
				</div>
				...
				<div class="target-section ready section1">
					<div class="content">
						<span class="caramel">CaramelLatte</span>
						<ul>
							<li><img src="img/CaramelLatte1.jpg"></li>
							<li><img src="img/CaramelLatte2.jpg"></li>
							<li><img src="img/CaramelLatte3.jpg"></li>
						</ul>
					</div>
				</div>
				...
				<div class="slide" id="CaramelLatte"> 
					<div class="rolling_list">
					<script>
						for(let i = 1; i <= 9; i ++) {
							document.write('<div class="slide_wrap slide_num' + i + '"><img src="img/06_caramel-latte/' + i + '.jpg"></div>');
						}
					</script>
					</div>
				</div>
