...
<link rel="stylesheet" href="./css/sub5_02.css">
				<div class="sub_container">
					...
					<div class="inner">
						...
						<ul class="tab">
							...
							<li class="on"><a href="/page/sub5/sub5_023.php">어반모던</a></li>
				...
				<div class="target-section ready section0" id="UrbanModern">
					<div class="content">
						<h4 class="white">어반모던</h4>
						<span>Concept</span>
						<p class="white">포인트 색상을 적절히 사용해 고급스러운 공간을 연출한 컨셉으로<br>고급스러움은 물론 카페 이상의 분위기를 느낄 수 있습니다.</p>
					</div>
				</div>
				...
				<div class="target-section ready section1">
					<div class="content">
						<span class="blue">Urban Modern</span>
						<ul>
							<li><img src="img/UrbanModern1.jpg"></li>
							<li><img src="img/UrbanModern2.jpg"></li>
							<li><img src="img/UrbanModern3.jpg"></li>
						</ul>
					</div>
				</div>
				...
				<div class="slide" id="UrbanModern"> 
					<div class="rolling_list">
					<script>
						for(let i = 1; i <= 10; i ++) {
							document.write('<div class="slide_wrap slide_num' + i + '"><img src="img/03_urban-modern/' + i + '.jpg"></div>');
						}
					</script>
					</div>
				</div>
