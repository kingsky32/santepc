        ...
        (function init() {
          ...
          insertTargetPosition();
				...
				<div class="sub_container">
					...
					<div class="inner">
						...
						<ul class="tab">
							...
							<li class="on"><a href="/page/sub5/sub5_027.php">뉴엔틱</a></li>
						</ul>
					</div>
				</div>
				<div class="target-section section"></div>
				<div class="target-section ready section0" id="NewAntique">
					<div class="content">
						<h4 class="black">뉴엔틱</h4>
						<span>Concept</span>
						<p class="black">따뜻하고 고급스러운 색감의 마감제로 고풍스러운 느낌과<br>카페의 따뜻함을 느낄 수 있는 인테리어 컨셉입니다.</p>
					</div>
				</div>
				...
				<div class="target-section ready section1">
					<div class="content">
						<span class="caramel">NewAntique</span>
						<ul>
							<li><img src="img/Newantique1.jpg"></li>
							<li><img src="img/Newantique2.jpg"></li>
							<li><img src="img/Newantique3.jpg"></li>
						</ul>
					</div>
				</div>
				...
				<div class="slide" id="NewAntique"> 
					<div class="rolling_list">
					<script>
						for(let i = 1; i <= 10; i ++) {
							document.write('<div class="slide_wrap slide_num' + i + '"><img src="img/07_new-antique/' + i + '.jpg"></div>');
						}
					</script>
					</div>
				</div>
