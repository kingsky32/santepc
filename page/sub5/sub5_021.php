          ...
          insertTargetPosition();
				...
				<div class="sub_container">
					...
					<div class="inner">
						...
						<hr>
						<ul class="tab">
							<li class="on"><a href="/page/sub5/sub5_021.php">메탈릭</a></li>
				...
				<div class="target-section ready section0" id="metalic">
					<div class="content">
						<h4 class="white">메탈릭</h4>
						<span>Concept</span>
						<p class="white">금속 재질의 마감제를 사용하여 강렬함과 세련됨을 갖추었으며 조명에 따라<br>다양한 연출이 가능한 프리미엄 인테리어 컨셉입니다.</p>
						<a href="#">VR 보러가기</a>
					</div>
				</div>
				...
				<div class="target-section ready section1">
					<div class="content">
						<span>Metalic Interior</span>
						<ul>
							<li><img src="img/Meralic1.jpg"></li>
							<li><img src="img/Meralic2.jpg"></li>
							<li><img src="img/Meralic3.jpg"></li>
						</ul>
					</div>
				</div>
				...
				<div class="slide" id="metalic_slide"> 
					<div class="rolling_list">
					<script>
						for(let i = 1; i <= 24; i ++) {
							document.write('<div class="slide_wrap slide_num' + i + '"><img src="img/01_metalic/' + i + '.jpg"></div>');
						}
					</script>
