      ...
      jQuery(document).ready(function ($) {
        ...
        (function init() {
          ...
          insertTargetPosition();
				...
				<div class="sub_container">
					...
					<div class="inner">
						...
						<ul class="tab">
							...
							<li class="on"><a href="/page/sub5/sub5_024.php">이스테이션</a></li>
				...
				<div class="target-section ready section0" id="E-Station">
					<div class="content">
						<h4 class="white">이스테이션</h4>
						<span>Concept</span>
						<p class="white">과거의 빈티지한 레트로 감성을 현대의 감수성으로<br>재해석한 프리미엄 인테리어 컨셉입니다.</p>
					</div>
				</div>
				...
				<div class="target-section ready section1">
					<div class="content">
						<span class="green">E-Station</span>
						<ul>
							<li><img src="img/E-Station1.jpg"></li>
							<li><img src="img/E-Station2.jpg"></li>
							<li><img src="img/E-Station3.jpg"></li>
						</ul>
					</div>
				</div>
				...
				<div class="slide" id="E-Station"> 
					<div class="rolling_list">
					<script>
						for(let i = 1; i <= 10; i ++) {
							document.write('<div class="slide_wrap slide_num' + i + '"><img src="img/04_E-station/' + i + '.jpg"></div>');
						}
					</script>
					</div>
				</div>
