...
<div class="sub_container">
  ...
  <div class="inner">
							...
							<hr>
							<iframe id="player" type="text/html" width="870" height="460" src="http://www.youtube.com/embed/JLLrQRCtw50" frameborder="0"></iframe>
							<div class="wrap">
								...
								<ul>
									<li>
										<a href="">
											<div><img src="img/interview.jpg" class="thumb"></div>
											<div>
												<p>직접 은행 가지 않고 샹떼에서 다 알아서 해줬어요.<br>너무 편했죠.</p>
												<span>- 강릉점 인터뷰</span>
											</div>
										</a>
									</li>
