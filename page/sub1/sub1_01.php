...
<div class="sub_container">
  ...
  <div class="inner">
    <h3 class="title">항상 변화를 꿈꾸는 PC방 프랜차이즈 ONLY.1 상떼PC방</h3>
    <hr>
  </div>
  ...
  <div class="inner">
    ...
    <section class="grid">
      <article style="background-image: url('<?php echo G5_IMG_URL ?>/sub/sub1/sub1_01_grid_img_1.png')"><a href="">
          <h5>최대 3억5천만원 대출</h5>
      ...
      <article style="background-image: url('<?php echo G5_IMG_URL ?>/sub/sub1/sub1_01_grid_img_2.png')"><a href="">
          <h5>안심 재창업 119</h5>
          <p>목표매출 미달성시 창업비용을<br>
            100% 보장해드립니다.</p>
          <div class="more">자세히 보기</div>
        </a></article>
      <article style="background-image: url('<?php echo G5_IMG_URL ?>/sub/sub1/sub1_01_grid_img_3.png')"><a href="">
          <h5>투자원금 보장제도</h5>
          <p>폐점률 0%에 도전!<br>
            원금은 보장받고 수익은 무한대로~</p>
          <div class="more">자세히 보기</div>
        </a></article>
      <article style="background-image: url('<?php echo G5_IMG_URL ?>/sub/sub1/sub1_01_grid_img_4.png')"><a href="">
