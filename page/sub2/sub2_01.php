        ...
        <article>
          ...
          <div class="text">
            <ul>
              ...
              <li>· 공사 완료 일정 확인 및 현장 체크</li>
              <li>· PC입고 전 꼼꼼한 제품 검수</li>
            </ul>
            <ul>
              <li>· 점주님 운영 교육</li>
              <li>· 오픈 전 체크리스트 작성</li>
        ...
        <article>
          ...
          <div class="text">
            <ul>
              ...
              <li>· 인근 경쟁 지점 조사</li>
              <li>· 점주와의 협의 하에 문제점 개선</li>
            </ul>
            <ul>
              <li>· 매장 매출 데이터 분석</li>
              <li>· 매출 개선 보고서 작성 및 실행</li>
              <li>· 사후 검토</li>
            </ul>
          </div>
        </article>
  ...
  <section class="section-08" id="page6"
    ...
    <div class="inner">
      ...
      <article>
        ...
        <ul>
          <li>· 손쉬운 PC복구 및 자가수리!</li>
          <li>· CD-KEY 관리 및 프로그램 관리</li>
          <li>· 24시간 풀가동 원격 지원 가능</li>
        </ul>
      </article>
      <article>
        <div class="thumb">
        ...
        <ul>
          <li>· 신속한 A/S 및 케어 가능!</li>
          <li>· 5분 이내 문제 해결</li>
          <li>· 전국 어디서나 원격지원 가능</li>
        </ul>
      </article>
    </div>
  </section>
