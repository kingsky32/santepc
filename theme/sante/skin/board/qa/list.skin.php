...
<div class="sub_container">
    ...
    <div class="inner">
                ...
                <div class="qna_wrap">
                    <ul>
                            ...
                            <li>
                                ...
                                <img src="<?php echo G5_IMG_URL ?>/arrow-down.png" alt="arrow">
                                <?php if ($is_checkbox) { ?>
                            ...
                            <?php } ?>
                            <?php if (count($list) == 0) { echo '<li><td class="empty_table">게시물이 없습니다.</td></li>'; } ?>
                    </ul>
                </div>
        ...
        <!-- } 게시판 목록 끝 -->
            <script>
                $('.sub_container .qna_wrap ul li').on('click', function () {
