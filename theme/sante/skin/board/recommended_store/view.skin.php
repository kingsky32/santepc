...
;
    ...
    <section id="bo_v_atc">
        ...
        <div id="bo_v_con">
            ...
            이메일 주소: <?php echo get_view_thumbnail($view['wr_email']); ?><br>
            연락처: <?php echo get_view_thumbnail($view['wr_1']); ?><br>
            점포평수: <?php echo get_view_thumbnail($view['wr_4']); ?><br>
            희망창업지역: <?php echo get_view_thumbnail($view['wr_2']) ?> <?php echo get_view_thumbnail($view['wr_3']) ?><br>
            상담희망내용: <?php echo get_view_thumbnail($view['content']); ?>
        </div>
